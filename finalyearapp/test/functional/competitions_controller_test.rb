...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { entryfee: @competition.entryfee, level: @competition.level, name: @competition.name, prize: @competition.prize, rules: @competition.rules, sponsor: @competition.sponsor }
    end
  ...
  test "should update competition" do
    put :update, id: @competition, competition: { entryfee: @competition.entryfee, level: @competition.level, name: @competition.name, prize: @competition.prize, rules: @competition.rules, sponsor: @competition.sponsor }
    assert_redirected_to competition_path(assigns(:competition))
  end
