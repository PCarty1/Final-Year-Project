...
class PicsControllerTest < ActionController::TestCase
  ...
  test "should create pic" do
    assert_difference('Pic.count') do
      post :create, pic: { feeling: @pic.feeling, image: @pic.image, location: @pic.location, name: @pic.name }
    end
  ...
  test "should update pic" do
    put :update, id: @pic, pic: { feeling: @pic.feeling, image: @pic.image, location: @pic.location, name: @pic.name }
    assert_redirected_to pic_path(assigns(:pic))
  end
